-- Legal Case Management System - Simple Seed Data
...
INSERT OR IGNORE INTO cases (case_number, title, description, client_id, primary_officer_id, status_id, case_type, priority, court_name, case_value, filing_date, summary) VALUES 
  ('2024-CV-001', 'Smith v. Insurance Co.', 'Personal injury claim from automobile accident', 1, 2, 2, 'Civil Litigation', 'High', 'Superior Court of State', 125000.00, '2024-01-15', 'Client suffered injuries in rear-end collision'),
  ('2024-CR-002', 'State v. Garcia', 'Criminal defense - DUI charge', 3, 2, 2, 'Criminal Defense', 'Medium', 'Municipal Court', 0.00, '2024-02-20', 'First-time DUI offense'),
  ('2024-CO-003', 'TechCorp Acquisition', 'Corporate acquisition due diligence', 2, 1, 2, 'Corporate Law', 'High', NULL, 2500000.00, '2024-01-30', 'Representing TechCorp in acquisition'),
  ('2024-FA-004', 'Wilson Divorce', 'Contested divorce with child custody', 5, 3, 2, 'Family Law', 'Medium', 'Family Court', 0.00, '2024-03-01', 'High-conflict divorce with custody issues'),
  ('2024-CO-005', 'Green Energy Contract Dispute', 'Breach of contract claim', 4, 5, 1, 'Civil Litigation', 'High', 'Commercial Court', 750000.00, '2024-03-15', 'Supplier failed to deliver solar panels');
...
INSERT OR IGNORE INTO case_notes (case_id, title, content, note_type, author_id) VALUES 
  (1, 'Initial Case Assessment', 'Client has strong case based on clear liability. Defendant ran red light and rear-ended client.', 'Strategy', 2),
  (1, 'Client Communication', 'Spoke with client about treatment progress. Physical therapy going well.', 'Client Communication', 2),
  (2, 'Prosecution Meeting', 'Met with DA office. They are open to plea agreement for reckless driving.', 'Court Update', 2),
  (3, 'Due Diligence Update', 'Financial records look clean. Need to review employee contracts carefully.', 'General', 1),
  (4, 'Custody Concerns', 'Client concerned about ex-spouse drinking. Need to investigate supervised visitation.', 'Strategy', 3),
